...
public class Hamster extends Pet{
    public Hamster(String name, String skills, String color, String breed, String age, String birthdate) {
    ...
    public  void toChangeBreed(String changeBreed){
        ...
        System.out.println("Хомяку " + getName() + " изменили породу: " + changeBreed);
    }
}